...
- CI/CD Trigger: Pull Request to main/staging branches
...
- Identity Provider: Azure Active Directory (Aka. Microsoft Entra) for management resources, Google Auth for applications
